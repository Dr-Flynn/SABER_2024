...
default_terms_csv = "terms_template (Flynn) - terms_template.csv"
...
app_author = "courtesy of University of Minnesota- Twin Cities, College of Biological Sciences"
